...
public class CreateMoreSignalsCreativeModeTabs {


    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, CreateMoreSignals.MODID);

    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAIN_TAB = CREATIVE_MODE_TABS.register("main",
            () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.create_more_signals.main"))
                    .withTabsBefore(AllCreativeModeTabs.PALETTES_CREATIVE_TAB.getId())
                    .icon(CreateMoreSignalsBlocks.THREE_COLOR_LIGHT_SIGNAL::asStack)
                    .displayItems(new RegistrateDisplayItemsGenerator(CreateMoreSignalsCreativeModeTabs.MAIN_TAB))
                    .build());
    ...
    private static class RegistrateDisplayItemsGenerator implements CreativeModeTab.DisplayItemsGenerator {
        ...
        private List<Item> collectBlocks() {
            ...
            for (RegistryEntry<Block, Block> entry : CreateMoreSignals.registrate().getAll(Registries.BLOCK)) {
        ...
        private List<Item> collectItems(DeferredHolder<CreativeModeTab, CreativeModeTab> tab, Predicate<Item> exclusionPredicate) {
            ...
            for (RegistryEntry<Item, Item> entry : CreateMoreSignals.registrate().getAll(Registries.ITEM)) {
