...
public class SignalPoleItem extends BlockItem {
    public SignalPoleItem(Block pBlock, Properties pProperties) {
    ...
    public InteractionResult place(BlockPlaceContext pContext) {
        ...
        IPlacementHelper placementHelper = PlacementHelpers.get(SignalPoleBlock.placementHelperId);
