...
public class CrossingLightsItem extends BlockItem {
    public CrossingLightsItem(Block pBlock, Properties pProperties) {
    ...
    public InteractionResult place(BlockPlaceContext pContext) {
        ...
        IPlacementHelper placementHelper = PlacementHelpers.get(CrossingLightsBlock.placementHelperId);
