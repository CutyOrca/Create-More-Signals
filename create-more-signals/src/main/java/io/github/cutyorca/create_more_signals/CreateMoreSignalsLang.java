...
public class CreateMoreSignalsLang extends Lang {
    /**
    ...
    public static MutableComponent translateDirect(String key, Object... args) {
        ...
        return Component.translatable(CreateMoreSignals.MODID + "." + key, args1);
    }
    ...
    public static LangBuilder builder() {
        return new LangBuilder(CreateMoreSignals.MODID);
    }
