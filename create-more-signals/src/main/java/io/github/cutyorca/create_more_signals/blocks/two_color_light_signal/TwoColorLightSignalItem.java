...
public class TwoColorLightSignalItem extends BlockItem {
    public TwoColorLightSignalItem(Block pBlock, Properties pProperties) {
    ...
    public InteractionResult place(BlockPlaceContext pContext) {
        ...
        IPlacementHelper placementHelper = PlacementHelpers.get(TwoColorLightSignalBlock.placementHelperId);
